...
lines_File3 = [lines1.rstrip('\n') for lines1 in open('s4.pdb_data8.pdb')]
lines_File4 = [lines1.rstrip('\n') for lines1 in open('s5.pdb_data8.pdb')]
lines_File5 = [lines1.rstrip('\n') for lines1 in open('s6.pdb_data8.pdb')]
lines_File6 = [lines1.rstrip('\n') for lines1 in open('s7.pdb_data8.pdb')]
lines_File7 = [lines1.rstrip('\n') for lines1 in open('s8.pdb_data8.pdb')]
